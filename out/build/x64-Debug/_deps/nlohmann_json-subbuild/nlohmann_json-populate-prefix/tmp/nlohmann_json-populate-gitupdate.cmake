...
execute_process(
  COMMAND "E:/Git/cmd/git.exe" --git-dir=.git show-ref "v3.11.3"
  WORKING_DIRECTORY "E:/my_projects/Terra Prima/out/build/x64-Debug/_deps/nlohmann_json-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'E:/my_projects/Terra Prima/out/build/x64-Debug/_deps/nlohmann_json-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'E:/my_projects/Terra Prima/out/build/x64-Debug/_deps/nlohmann_json-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
